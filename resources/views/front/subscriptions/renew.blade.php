    ...
    <div class="container-xxl py-5">
        <div class="container">
            ...
            <div class="row d-flex justify-content-center">
                @if ($days_left < 7)
                    <p class="fw-bold fs-5 text-center text-secondary">@lang('It will cost you') {{ $next_subscription['amount'] }} XAF @lang('and go from') {{ $next_subscription['starts_at'] }} @lang('to ') {{ $next_subscription['ends_at'] }}.</p>
