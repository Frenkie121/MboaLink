            ...
            <div class="row gy-5 gx-4">
                ...
                <div class="col-lg-8">
                    <div class="d-flex align-items-center mb-5">
                        ...
                        <div class="text-start ps-4">
                            ...
                            <span class="text-truncate me-3"><i class="fa fa-map-marker-alt text-primary me-2"></i>{{ $job->company->user->userable->location }}</span>
                ...
                <div class="col-lg-4">
                    ...
                    @if (! in_array(auth()->user()->role_id, [1, 2]))
                        @livewire('front.apply-job', ['job' => $job], key($job->id))
                    @endif
                    ...
                    <div class="bg-light rounded p-5 wow slideInUp" data-wow-delay="0.1s">
                        ...
                        <p><i class="fa fa-map-marker-alt text-primary me-2"></i> {{ $job->company->user->userable->location }}</p>
